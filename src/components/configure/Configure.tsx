...
const ConfigureScreen = () => {
    ...
    return (
        <div className="h-[calc(100vh_-_64px)] flex flex-col bg-gray-100">
            <div className="px-4 py-4 flex justify-between items-cente w-screen border-b border-gray-200 bg-white shadow-lg h-[72px]">
            ...
            <div className="flex justify-center items-center w-screen flex-1  bg-gray-300 ">
                <div className="flex w-full h-full">
                    ...
                    <div className="flex-1 bg-gray-200 h-[calc(100vh_-_64px-_72px)] overflow-y-auto">
                        <Outlet />
                    </div>
                </div>
            </div>
